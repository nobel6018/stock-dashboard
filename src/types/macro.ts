...
export const MACRO_INDICATORS: MacroIndicator[] = [
  // ===== 통화/유동성 =====
  {
    ...
    unit: "",
    color: "#22c55e",
    description: "ICE U.S. Dollar Index (DXY). 6개 주요 통화 바스켓 대비 달러 강도(EUR 57.6%, JPY 13.6%, GBP 11.9%, CAD 9.1%, SEK 4.2%, CHF 3.6%). 1973년 3월 = 100. 상승 → 달러 강세, 자산 가격 역풍(특히 신흥국·원자재·금). 하락 → 달러 약세, 위험자산·금·이머징 순풍. 재정 지배·통화 희석 테제의 핵심 검증 지표. 100 기준 위/아래로 달러 강도 판단.",
    category: "통화/유동성",
  },
  {
    id: "us-m2",
